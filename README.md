...
docker run -p 8053:8053 --name product-service-container product-service:latest

docker build -t inventory-service:latest ./inventory-service
docker run -p 8052:8052 --name inventory-service-container inventory-service:latest
